...
class RadioButton extends Component {
  ...
  render () {
    const {active, label, bgColor, buttonContainerStyle, buttonTextStyle,
    buttonContainerActiveStyle, buttonTextActiveStyle,
    buttonTextInactiveStyle} = this.props;

    var buttonContainerInactiveStyle = {};

    if(bgColor){
      buttonContainerInactiveStyle = JSON.parse(JSON.stringify(this.props.buttonContainerInactiveStyle));
      buttonContainerInactiveStyle.backgroundColor = bgColor;
    }
